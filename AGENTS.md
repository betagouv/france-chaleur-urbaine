...
| [data-table module](src/modules/data-table/AGENTS.md) | Building or editing **any data table** (list, columns, filters, export) — `useDataTable` + `DataTable`; `TableSimple` is frozen |
