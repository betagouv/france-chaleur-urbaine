...
import RessourcesGeothermalesNappesAdapter from './adapters/ressources-geothermales-nappes';
...
export const tilesAdapters = {
  ...
  'ressources-geothermales-nappes': RessourcesGeothermalesNappesAdapter,
};
