...
Add the ability for registered users to view and track their own demands through a dedicated `/user/demandes` page. This involves linking demands to user accounts and creating a user-facing interface.
...
3. Create `/user/demandes` page for users to view their demands
