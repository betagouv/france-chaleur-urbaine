...
export const variantClassNames = {
  ...
  destructive: {
    primary: 'bg-destructive/90! text-white! hover:bg-destructive! active:bg-destructive/80!',
    secondary: 'border-destructive! text-destructive! shadow-destructive!',
    tertiary: 'text-destructive!',
    'tertiary no outline': '',
  },
  faded: {
    primary: 'bg-faded/90! text-white! hover:bg-faded! active:bg-faded/80!',
    secondary: 'border-faded! text-faded! shadow-faded',
    tertiary: 'text-faded!',
    'tertiary no outline': '',
  },
  info: {
    primary: 'bg-info/90! text-white! hover:bg-info! active:bg-info/80!',
