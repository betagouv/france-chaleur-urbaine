...
const DistrictHeating = ({
  ...
  return (
    <Container>
      <Subtitle ref={chauffageUrbainRef}>Qu’est-ce que le chauffage urbain ?</Subtitle>
      <WithVideo>
        <div>
          <b>Une installation de chauffage urbain</b>, aussi appelée <b>réseau de chaleur</b>, est constituée de{' '}
          <b>
            canalisations qui permettent d’acheminer vers un ensemble de bâtiments de la chaleur produite localement, à partir d’énergies
            renouvelables ou de récupération
          </b>
          . Ce mode de chauffage est principalement développé en milieu urbain, dès lors qu’une concentration suffisamment dense de
          ...
          <ul>
            <li>
              <b>une unité de production de chaleur :</b> il s’agit d’installations robustes et fiables, surveillées en permanence et
              entretenues par des professionnels. Elles exploitent{' '}
              <Link href="/ressources/energies-vertes#contenu">différents types d’énergie</Link>
              {' '}:{' '}
              <ul>
                <li>
                  des <b>énergies de récupération</b>, en particulier la chaleur issue de l’incinération des ordures ménagères ;
                </li>
                <li>
                  des <b>énergies renouvelables</b> : combustion de la biomasse dans une chaufferie collective, installation de géothermie
                  profonde pour extraire la chaleur du sous-sol…
                </li>
                <li>
                  des <b>énergies fossiles</b> telles le gaz ou le fioul, qui sont le plus souvent utilisées <b>en renfort</b> pendant les
      ...
      <ul>
        <li>
          <b>un réseau de distribution dit « primaire » :</b> il est composé de canalisations qui transportent la chaleur sous forme d’un
          fluide caloporteur (eau chaude en général, plus rarement vapeur d’eau). Ce réseau comprend un circuit aller qui achemine vers les
          bâtiments le fluide chaud issu de l’unité de production, et un circuit retour qui rapporte le fluide refroidi vers la chaufferie
          centrale, où il est à nouveau réchauffé et renvoyé dans le circuit.
        </li>
        <br />
        <li>
          <b>les sous-stations d’échange :</b> situées en pied d’immeuble, elles permettent de transférer la chaleur du circuit primaire
          vers un réseau dit « secondaire », interne au bâtiment à chauffer. Le réseau secondaire est géré par le bâtiment et non par le
          gestionnaire du réseau de chaleur. La sous-station comprend généralement un échangeur ainsi qu’un compteur de la chaleur
          transférée, qui permet de connaître la consommation d’énergie du bâtiment (nécessaire pour la facturation).
        </li>
      </ul>
      <br />
      <br />
      ...
      <ul>
        <br />
        <li>
          <b>Un mode de chauffage fiable :</b> se raccorder à un réseau de chaleur permet de bénéficier de la garantie d’un service public
          pour son chauffage. Un autre avantage majeur est la suppression des chaudières en bas d’immeuble, et des risques et nuisances qui
          leur sont associés.
        </li>
        <br />
        <li>
          <b>Une source d’emploi locale :</b> la création, le développement et l’exploitation d’un réseau de chauffage urbain constituent
          une source d’emplois locaux, non délocalisables. Aujourd’hui, la filière recrute pour répondre au regain d’intérêt pour ce mode de
      ...
      exclusive : des réseaux de chaleur peuvent être créés par d’autres acteurs, y compris des acteurs privés.
      <br />
      <br />
      ...
      délégations de service public. La gestion du réseau en régie par la collectivité suppose en effet qu’elle dispose au sein de ses
      services de moyens techniques et humains qui lui permettent d’assurer le fonctionnement et l’entretien des installations.
      <br />
      <br />
      Aujourd'hui, la majorité des grandes villes ont équipé leur territoire de réseaux de chaleur. C'est par exemple le cas à{' '}
      <Link href="/villes/paris">Paris</Link>, <Link href="/villes/rennes">Rennes</Link>, <Link href="/villes/nantes">Nantes</Link>,{' '}
      ...
      <br />
      <br />
      Le fait qu’il existe différents modes de gestion et de nombreux acteurs impliqués peut rendre difficile l’accès à l’information.{' '}
      <b>
        Comment savoir si mon territoire est équipé du chauffage urbain et à qui m’adresser pour me raccorder ? C’est ce que vous propose
        France Chaleur Urbaine
      </b>
      , qui vous offre la possibilité de tester votre adresse et d’être mis en relation avec le gestionnaire du réseau de chaleur le plus
      proche.
      <br />
      <br />
      <br />
      ...
      des distances comprises entre 100 et 200 m. Toutefois, seul le gestionnaire du réseau pourra confirmer la faisabilité du raccordement,
      en fonction des caractéristiques du bâtiment et de celles du réseau.
      <br />
      <br />
      <ul>
        <li>
      ...
      Les <b>bâtiments déjà équipés d’un chauffage collectif (gaz ou fioul)</b> sont les plus faciles à raccorder au chauffage urbain. En
      effet, ils disposent de la tuyauterie nécessaire et des équipements adaptés au sein des logements. Lorsque le bâtiment est chauffé au
      gaz individuel, les logements disposent des équipements adaptés mais le réseau secondaire, qui permettra de distribuer la chaleur au
      sein de l’immeuble, devra être créé. Cela peut s’avérer coûteux et nécessite des travaux conséquents. Enfin, le cas le moins favorable
      est celui des bâtiments chauffés à l’électricité, pour lesquels le raccordement au chauffage urbain impliquera de mettre en place à la
      fois les équipements au sein des logements et le réseau secondaire, donc des travaux très coûteux et conséquents aussi bien dans les
      logements que dans les parties communes.
      <br />
      <br />
      <br />
      <Subtitle ref={obligationRef}>Existe-t-il des obligations de raccordement au chauffage urbain ?</Subtitle>
      <WithImage>
        <div>
          Il existe une{' '}
          <b>
            obligation de raccordement pour les bâtiments neufs ou renouvelant leur installation de chauffage au-dessus d’une certaine
            puissance
          </b>
          , dès lors qu’ils sont situés <b>dans le périmètre de développement prioritaire d’un réseau de chauffage urbain classé</b>
          .
          <br />
          <br />
          <ul>
          ...
          La loi Énergie Climat de 2019 et la loi Climat et Résilience de 2021 ont instauré le classement automatique des réseaux de
          chaleur.{' '}
          <b>
            Tous les réseaux de service public sont désormais automatiquement classés dès lors qu’ils répondent aux trois critères suivants
            :
          </b>
          <ul>
            <ul>
              <li>un taux d’énergies renouvelables et de récupération supérieur à 50 %,</li>
      ...
      <ul>
        <ul>
          <li>
            tout <b>bâtiment neuf</b> dont les besoins de chauffage sont supérieurs à une puissance de 30 kW ;
          </li>
          <li>
            tout <b>bâtiment renouvelant son installation de chauffage</b> au-dessus d’une puissance de 30 kW.
          </li>
        </ul>
      </ul>
      <br />
      ...
      <ul>
        <ul>
          <li>besoins de chaleur ou de froid incompatibles avec les caractéristiques techniques du réseau ;</li>
          <li>installation qui ne peut être alimentée par le réseau dans les délais nécessaires ;</li>
          <li>
            solution mise en œuvre alimentée par des énergies renouvelables et de récupération à un taux supérieur à celui du réseau
            classé ;
          </li>
          <li>coût manifestement disproportionné pour le raccordement et l’utilisation du réseau.</li>
        </ul>
      </ul>
      <br />
      <br />
      <Subtitle ref={accompagnementRef}>Comment être accompagné dans mon projet de raccordement ?</Subtitle>
      La première question à se poser avant le changement d’un mode de chauffage est celle de l’isolation du bâtiment.{' '}
      ...
      50 000 € peut être perçue par une copropriété d’une centaine de lots, permettant ainsi de réduire le coût par logement du raccordement
      ...
      collectifs et tertiaires » (une seule prime par opération), dont la liste est accessible{' '}
      <a
      ...
      .{' '}
      <b>
        Son montant est fortement variable d’un signataire à l’autre, il est donc primordial de solliciter plusieurs devis pour comparer les
        offres !
      </b>
      <br />
      <br />
