...
const contents = [
  {
    ...
    list: [
      ...
      <>
        Tarifs élevés et <b>fortement fluctuants</b> (près de 67 % de hausse
        entre septembre 2021 et août 2022)
      </>,
      <>
  ...
  },
  {
    ...
    list: [
      ...
      <>
        <b>Entretien rigoureux</b> des installations nécessaire pour limiter les
        risques associés aux chaudières
      </>,
      <>
  ...
  },
  {
    ...
    list: [
      ...
      <>
        <b>
          Absence de chaudière et de stockage au sein de l’immeuble - sécurité
          assurée
        </b>
      </>,
      <>
      ...
      <>
        <b>
          Tarifs compétitifs et moins fluctuants que ceux des énergies purement
          fossiles
        </b>
        ,
        <br />
        TVA à 5.5 % pour tous les réseaux alimentés plus de 50 % par des
        énergies renouvelables et de récupération.
        <br />
        <br />
        La couverture du territoire national par les réseaux de chaleur est
        encore hétérogène. Renseignez votre adresse ci-dessus pour vérifier si
        un réseau passe près de chez vous !
      </>,
    ],
  },
];
