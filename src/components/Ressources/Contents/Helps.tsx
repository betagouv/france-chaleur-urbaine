  ...
  return (
    <>
      ...
      *Le dispositif des Certificats d’économies d’énergie repose sur une obligation de réalisation d’économies d’énergie imposée par les
      ...
      Cette offre s’adresse aux <b>propriétaires et gestionnaires de bâtiments résidentiels collectifs et tertiaires.</b>
      <br />
      ...
      <br />
      <br />
      Les montants exacts dépendent cependant des offres commerciales de chaque signataire de la charte.
      <br />
      <br />
      <Highlight>
      ...
      <BlueText>1.</BlueText> Vérifier que je remplis les conditions d’attribution
      <br />
      <br />
      <BlueText>2.</BlueText> Comparer les offres proposées par les signataires et choisir un signataire
      <br />
      <br />
      <BlueText>3.</BlueText> Accepter l'offre du signataire de la charte (ou un de ses partenaires) avant de signer le devis des travaux.
      Cette offre devra obligatoirement comporter un document décrivant la proposition
      <br />
      <br />
      <BlueText>4.</BlueText> Signer le devis proposé par un professionnel pour la réalisation des travaux
      <br />
      <br />
      <BlueText>5.</BlueText> Faire réaliser les travaux par le professionnel
      <br />
      <br />
      <BlueText>6.</BlueText> Retourner les documents (factures, attestations sur l’honneur, etc.) au signataire de la charte ou à son
      partenaire dans les délais prévus
      <br />
      <br />
      <br />
      ...
      <List>
        ...
        <li>Prendre d’autres formes convenues avec le signataire de la charte lors de la contractualisation de son offre.</li>
      </List>
      <Source>
        Pour en savoir plus :{' '}
        <a
