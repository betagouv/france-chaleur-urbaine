...
const Livraisons = () => {
  return (
    <>
      <p>
        <b>Notre pays dispose pourtant d’un fort potentiel de développement des réseaux de chaleur !</b>
      </p>
      ...
      <br />
      <b>
        La loi de transition énergétique pour la croissance verte de 2015 fixe l’objectif de multiplier par 5 la quantité de chaud et de
        froid renouvelables livrés par les réseaux en 2030, par rapport à 2012.
      </b>
      <br />
      <br />
