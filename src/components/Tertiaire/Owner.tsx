    ...
    <Box className="fr-container" id="decrettertiaire" py="10w">
      ...
      <ResponsiveRow mt="10w">
        <Box flex>
          <Box>
            ...
            <Text size="lg" mt="3w">
              ...
              ou encore engager des travaux de rénovation énergétique.
            </Text>
            <Text size="lg" mt="3w">
            ...
            <ResponsiveRow alignItems="center" gap="20px">
              <Box textColor="#4550E5">
                ...
                <Text size="md" fontWeight="bold">
                  de réduction des consommations d’énergie finale de l’ensemble parc tertaire d’au moins* :
                </Text>
                <Text size="xs">
                  <Link href="https://www.ecologie.gouv.fr/sites/default/files/20064_EcoEnergieTertiaire-4pages-web.pdf" isExternal>
                    * En savoir plus
                  </Link>
                </Text>
              </Box>
        ...
        <Box flex>
          <Box>
            <Text size="lg">
              Le 13 avril 2022, un arrêté modifiant celui du 10 avril 2020 relatif aux obligations d’actions de réduction des consommations
              d’énergie finale dans des bâtiments à usage tertiaire a été publié.
            </Text>
            <Text size="lg">
              Il spécifie qu’un coefficient de 0,77 sera appliqué aux consommations d’énergie des bâtiments raccordés aux réseaux de
              chaleur.
            </Text>
          </Box>
          <Box backgroundColor="blue-france-main-525" mt="3w" px="4w" py="2w" textColor="#ffffff" fontWeight="bold">
            ...
            <ResponsiveRow alignItems="center" mt="2w">
              ...
              <Box>
                <Text size="lg">de réduction de consommations d’énergie comptabilisée&nbsp;!</Text>
              </Box>
            </ResponsiveRow>
          </Box>
        </Box>
