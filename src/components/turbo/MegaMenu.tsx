...
export const MegaMenu = memo(
  forwardRef<HTMLDivElement, MegaMenuProps & { id: string }>((props, ref) => {
    ...
    return (
      <div className={cx(fr.cx('fr-mega-menu'), classes.root)} style={style} tabIndex={-1} id={id} ref={ref} {...rest}>
                ...
                <div className={cx(fr.cx('fr-mega-menu__leader'), classes.leader)}>
                  ...
                  {leader.link !== undefined && (
                    <Link
                      ...
                      className={cx(
                        fr.cx('fr-link', 'fr-icon-arrow-right-line', 'fr-link--icon-right', 'fr-link--align-on-content' as any),
            ...
            {categories.map(({ categoryMainLink, categoryMainText, links }, i) => (
              <div className={fr.cx('fr-col-12', 'fr-col-lg-3')} key={i}>
                ...
                {categoryMainText !== undefined && (
                  <h5 className={cx(fr.cx('fr-mega-menu__category', 'fr-nav__link'), classes.category)}>{categoryMainText}</h5>
                )}
