    ...
    <Box className="fr-container">
      ...
      <Box className="fr-grid-row fr-grid-row--gutters" mt="10w">
        <Box display="flex" flexDirection="column" alignItems="center" className="fr-col-12 fr-col-lg-6 fr-col-xl-3">
          <Image src="/img/copro_avantages_1.webp" alt="" width={120} height={100} priority className="img-object-contain" />
        ...
        <Box display="flex" flexDirection="column" alignItems="center" className="fr-col-12 fr-col-lg-6 fr-col-xl-3">
          <Image src="/img/copro_avantages_3.webp" alt="" width={120} height={100} priority className="img-object-contain" />
          <Text size="lg" textAlign="center" mt="2w">
        ...
        <Box display="flex" flexDirection="column" alignItems="center" className="fr-col-12 fr-col-lg-6 fr-col-xl-3">
          <Image src="/img/copro_avantages_4.webp" alt="" width={120} height={100} priority className="img-object-contain" />
          <Text size="lg" textAlign="center" mt="2w">
