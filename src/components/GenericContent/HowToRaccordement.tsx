...
const HowToRaccordement = ({ downloadLinkPos }: { downloadLinkPos?: DownloadLinkPos }) => {
  return (
    <Box className="fr-container">
      ...
      <ResponsiveRow mt="10w">
        <Box flex>
          ...
          <WhiteArrowPuce>
            <Text size="lg">Déposez une demande sur France Chaleur Urbaine</Text>
          </WhiteArrowPuce>
          <WhiteArrowPuce>
            <Text size="lg">France Chaleur Urbaine transmet votre demande au gestionnaire du réseau le plus proche de chez vous</Text>
          </WhiteArrowPuce>
          <WhiteArrowPuce>
            <Text size="lg">Le gestionnaire vous recontacte pour étudier avec vous votre projet de raccordement</Text>
          </WhiteArrowPuce>
