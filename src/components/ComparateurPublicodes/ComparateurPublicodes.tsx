          ...
          exportAsXLSX(`${fileName}.xls`, [
            {
              ...
              columns: [
                ...
                { name: `P1 abo (${engine.getUnit(`Bilan x ${modesDeChauffage[0].coutPublicodeKey} . P1conso`)})`, accessorKey: 'p1Abo' },
                {
                ...
                { name: `P1 ECS (${engine.getUnit(`Bilan x ${modesDeChauffage[0].coutPublicodeKey} . P1ECS`)})`, accessorKey: 'p1Ecs' },
                {
                ...
                { name: `Aides (${engine.getUnit(`Bilan x ${modesDeChauffage[0].coutPublicodeKey} . aides`)})`, accessorKey: 'aides' },
                {
