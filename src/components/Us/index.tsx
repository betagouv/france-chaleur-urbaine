  ...
  return (
    <>
      ...
      <Slice padding={4}>
        ...
        <List>
          <li>
            <b>Outiller</b> : Mise à disposition d’outils afin de valoriser les réseaux de chaleur : test de raccordement, cartographie des
            réseaux, simulateur de CO2...
          </li>
          <li>
      ...
      <Slice padding={4}>
        ...
        <p>
          France Chaleur Urbaine est financé par la Direction interministérielle du numérique, par la Direction générale de l’énergie et du
          climat du Ministère de la transition écologique, par l’ADEME et par la DRIEAT.
        </p>
        <Logos>
