...
- [MaPrimeRenov' Copropriétés](https://www.maprimerenov.gouv.fr/prweb/PRAuth/app/AIDES_/BPNVwCpLW8TKW49zoQZpAw*/!STANDARD), aide versée aux syndicats de copropriétés pour des travaux effectués sur les parties communes. Elle concerne notamment les équipements de raccordement à un réseau de chaleur lorsque celui-ci est majoritairement alimenté par des énergies renouvelables ou de récupération, ou encore la dépose des cuves à fioul. Des aides individuelles sont cumulables avec MaPrimeRenov' Copropriétés, au titre du dispositif MaPrimeRenov'.
- [Primes "Coups de pouce chauffage"](https://www.ecologie.gouv.fr/coup-pouce-chauffage-et-isolation), dont peuvent bénéficier l’ensemble des ménages (avec des montants fonction de leurs revenus) pour des travaux visant à substituer un chauffage fossile par un raccordement à un réseau de chaleur alimenté majoritairement par des énergies renouvelables et de récupération (voir [fiche CEE BAR-TH-137](https://www.ecologie.gouv.fr/sites/default/files/Fiche%20BAR-TH-137.pdf)). Les travaux doivent être réalisés par une entreprise qualifiée RGE.
