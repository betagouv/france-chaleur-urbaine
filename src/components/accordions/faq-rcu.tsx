const faqRcu = [
  ...
  },
  {
    ...
    - les abonnés refacturent par la suite le service aux usagers, conformément au règlement de copropriété.
    `,
  },
  {
    label:
