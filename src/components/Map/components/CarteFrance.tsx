...
interface Props {
  ...
  selectedTerritoireId: string | undefined;
...
function CarteFrance(props: Props) {
  ...
  function getTerritoireColor(territoireId: string): string {
    return props.selectedTerritoireId === territoireId
      ? '#86eee0'
      : props.donneesParTerritoire[territoireId]?.color ?? defaultFillColor;
  }
