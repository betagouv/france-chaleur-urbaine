...
import { LegendTrackingEvent, trackEvent } from '@/services/analytics';
import { MapConfigurationProperty, type MapConfiguration } from '@/services/Map/map-configuration';
