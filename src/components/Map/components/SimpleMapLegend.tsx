      ...
      {enabledFeatures.includes('proModeLegend') && (
        <>
          ...
          <Text fontSize="13px" lineHeight="18px" fontWeight="lightbold" fontStyle="italic" mt="2w" mx="2w">
            Pour voir plus de données, contribuer à la carte ou télécharger les tracés, activez le "Mode professionnel" en haut de la carte.
          </Text>
        </>
      )}
          ...
          <CollapsibleBox id="zonesOpportunite" expand={!!sectionsExpansions['zonesOpportunite']}>
            <DeactivatableBox disabled={!mapConfiguration.zonesOpportunite.show} display="flex" flexWrap="wrap" ml="3w" mr="1w">
              <Box display="flex">
                ...
                <IconPolygon stroke={themeDefZonePotentielChaud.fill.color} fillOpacity={themeDefZonePotentielChaud.fill.opacity} mt="1v" />
          ...
          <CollapsibleBox id="enrrMobilisables" expand={!!sectionsExpansions['enrrMobilisables']}>
            <DeactivatableBox disabled={!mapConfiguration.enrrMobilisables.show} ml="3w" mr="1w">
              ...
              <Box display="flex">
                ...
                <IconPolygon stroke={themeDefSolaireThermiqueFriches.color} fillOpacity={themeDefSolaireThermiqueFriches.opacity} mt="1v" />
        ...
        <>
          ...
          <Box display="flex">
            ...
            <InfoIcon>
              ...
              <Hoverable position="bottom">
                Les DPE affichés par bâtiment résultent d'un extrapolation des DPE par logement ancienne définition. Ils sont donnés à titre
