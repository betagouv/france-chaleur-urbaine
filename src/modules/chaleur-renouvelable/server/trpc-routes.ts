import { zLocationInfos, zRnbByBanIdInput } from '@/modules/chaleur-renouvelable/constants';
import { getBatEnrBatimentDetails, getLocationInfos, getRnbByBanId } from '@/modules/chaleur-renouvelable/server/service';
