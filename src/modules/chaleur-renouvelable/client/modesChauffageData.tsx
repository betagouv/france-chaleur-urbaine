...
type ModeDeChauffageWithoutTypeLogements = Omit<ModeDeChauffage, 'typeLogements'>;
...
const withTypeLogements = (typeLogements: TypeLogement[], heatingModes: ModeDeChauffageWithoutTypeLogements[]): ModeDeChauffage[] =>
  heatingModes.map((heatingMode) => ({ ...heatingMode, typeLogements }));
...
export function getModesDeChauffage(typeLogement: TypeLogement, situation: Situation) {
  return modesDeChauffage.filter((heatingMode) => heatingMode.typeLogements.includes(typeLogement) && heatingMode.estPossible(situation));
}
...
export function getIncompatibleSolutionRows(situation: Situation, typeLogement: TypeLogement): IncompatibleSolutionRow[] {
  return modesDeChauffage
    .filter((heatingMode) => heatingMode.typeLogements.includes(typeLogement))
    .flatMap((heatingMode) =>
