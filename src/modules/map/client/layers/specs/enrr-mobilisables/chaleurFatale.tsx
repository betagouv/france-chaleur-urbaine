...
import type { MapConfiguration } from '@/modules/map/client/config/map-configuration';
import {
  defineLayerPopup,
  ifHoverElse,
  ...
  type PopupHandler,
} from '@/modules/map/client/core/common';
import type { LayerSymbolImage } from '@/modules/map/client/core/layer-symbols';

type EnrrMobilisablesChaleurFataleImage = Extract<LayerSymbolImage, `enrr_mobilisables_${string}`>;
...
const PopupDatacenter = defineLayerPopup<Datacenter>((datacenter, { Property, Title, TwoColumns }) => {
  return (
    <>
...
const PopupIndustrie = defineLayerPopup<Industrie>((industrie, { Property, Title, TwoColumns }) => {
  return (
    <>
...
const PopupInstallationElectrogene = defineLayerPopup<InstallationElectrogene>(
  (installationElectrogene, { Property, Title, TwoColumns }) => {
    return (
      <>
...
const PopupStationsDEpuration = defineLayerPopup<StationDEpuration>((stationDEpuration, { Property, Title, TwoColumns }) => {
  return (
    <>
...
const PopupUniteDIncineration = defineLayerPopup<UniteDIncineration>((uniteDIncineration, { Property, Title, TwoColumns }) => {
  return (
    <>
