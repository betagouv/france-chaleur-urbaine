...
import { defineLayerPopup, type PopupStyleHelpers, type VectorSourceOptions } from '@/modules/map/client/core/common';
...
// Wrapper qui ne peut pas utiliser de hook ; il délègue à un vrai composant qui, lui, peut en utiliser
export const BdnbBatimentPopup = defineLayerPopup<BdnbBatimentTile>((caracteristiqueBatiment, helpers) => (
  <BdnbBatimentPopupContent caracteristiqueBatiment={caracteristiqueBatiment} {...helpers} />
));
