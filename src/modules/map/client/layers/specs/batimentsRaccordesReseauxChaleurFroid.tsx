...
import type { MapLayerSpecification } from '@/modules/map/client/core/common';
...
const Popup = defineLayerPopup<BatimentRaccordeReseauxChaleurFroid>(
  (batimentRaccordeReseauxChaleurFroid, { Property, Title, TwoColumns }) => {
    return (
      <>
