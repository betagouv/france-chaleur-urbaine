...
/** Small 24×8 rounded line swatch (V1's `8px height × 25px minWidth` block). */
 ...
 * Mirrors V1's `MapLegendReseaux.tsx` flat layout : single checkbox + three
 * colored "line" swatches (classés / non classés / non ouverts), with hint
 * sub-text. Filters (taux EnR&R, CO2, …) live in a separate filters panel —
 * not inline here.
 */
