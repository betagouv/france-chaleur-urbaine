...
export const zonesPotentielFroidLayersSpec = [
  {
    ...
    sourceId: 'zones-opportunite-froid',
  },

  {
    layers: [
      {
        id: 'zones-opportunite-fort-froid',
    ...
    sourceId: 'zones-opportunite-fort-froid',
  },
...
function buildPopup(fortFroid?: boolean) {
  const Popup = defineLayerPopup<ZonePotentielFroid>((zonePotentielFroid, { Property, Title, TwoColumns }) => (
    <>
