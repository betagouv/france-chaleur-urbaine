...
/**
 * Listing of tested addresses + their eligibility status. Reuses the
 * `<CardSearchDetails>` card (contact form modal, distance, badge…).
 *
 * Visual wrapper (white card / shadow / rounded) is owned by the parent so
 * the search input and results share a single card.
 */
export function EligibilityResultsPanel({
  ...
  // doesn't refire on every parent render.
