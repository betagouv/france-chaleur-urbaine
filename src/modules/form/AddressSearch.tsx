 ...
 */
export function AddressSearch({ onlyAddress, onlyCities, excludeCities, ...props }: AddressSearchProps) {
  // useCallback ensures fetchFn identity is stable — prevents debounce restarts on re-renders
  const fetchFn = useCallback(
    (query: string, signal: AbortSignal) => searchBANAddresses({ excludeCities, onlyAddress, onlyCities, query, signal }),
