        ...
        <Slice>
          ...
          <div className="my-8 [&_li]:cursor-pointer">
            ...
            <ul>
              ...
              <li onClick={() => acteursRef.current?.scrollIntoView()}>
                <u>Quels sont les acteurs en charge des réseaux de chaleur ?</u>
              </li>
              <li onClick={() => raccordablesRef.current?.scrollIntoView()}>
                <u>Tous les bâtiments sont-ils raccordables à un réseau de chaleur ?</u>
              </li>
              <li onClick={() => obligationsRef.current?.scrollIntoView()}>
              ...
              <li onClick={() => chaleurRef.current?.scrollIntoView()}>
              ...
              <li onClick={() => subventionRef.current?.scrollIntoView()}>
                <u>
