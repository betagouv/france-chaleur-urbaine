/**
 * Iframe carte V2 paramétrable via query string (générée par /admin/iframes).
 *
...
const CarteIframePage = () => {
  const [{ center, zoom, minZoom, maxZoom, maxBounds, gestionnaire, reseaux, layers, legend, mode }] = useQueryStates(carteIframeParams, {
