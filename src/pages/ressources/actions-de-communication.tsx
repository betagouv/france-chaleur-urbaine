...
const ActionsDeCommunicationPage = () => {
  return (
    <SimplePage title="Nos actions de communication - France Chaleur Urbaine">
      ...
      <Box pt="6w" className="fr-container fr-grid-row" display="flex">
        <Box
          display="flex"
      ...
      <Box pt="10w" className="fr-container fr-grid-row" display="flex">
        <Box
          display="flex"
          flexDirection="column"
          gap="16px"
      ...
      <Box pt="10w" className="fr-container fr-grid-row" display="flex">
        ...
        >
          ...
          <Text size="lg">
            ...
            Charleville-Mézières est étendu sur plus de 13 km. Cette période de
            travaux est un moment clé pour faire connaître le chauffage urbain
            et convaincre de nouveaux prospects de se raccorder. France Chaleur
            Urbaine a réalisé pour la ville et son délégataire Dalkia des
            visuels pour le journal communal, les bâches travaux, et de
            l’affichage sur abribus. Grâce à un relai actif par la collectivité,
            cette campagne a généré plus de 50 demandes de raccordement en 2
            mois.
          </Text>
        </Box>
        <Box className="fr-col fr-col-12 fr-col-lg-6">
      ...
      <Box py="10w" className="fr-container fr-grid-row" display="flex">
        <Box
          display="flex"
          flexDirection="column"
          gap="16px"
