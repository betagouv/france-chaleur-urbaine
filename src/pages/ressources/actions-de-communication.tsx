      ...
      <Box backgroundColor="blue-cumulus-950-100">
        ...
        >
          <Box flex>
            ...
            <Text size="lg" mb="3w">
              France Chaleur Urbaine aide les collectivités et les exploitants à
              faire la promotion du chauffage urbain et à rendre les réseaux
      ...
      <Box pt="6w" className="fr-container">
        <Box className="fr-grid-row fr-grid-row--gutters">
          <Box
            ...
            gap="16px"
            className="fr-col fr-col-12 fr-col-lg-6"
          >
            ...
            <Text size="lg">
              Porter à 80% le taux d’énergies renouvelables du réseau EVOS,
              aujourd’hui alimenté exclusivement au gaz, est le défi que
              s’engagent à relever l’Eurométropole de Strasbourg et son
              délégataire ENGIE Solutions. Grâce à ce projet, les abonnés et
              futurs abonnés vont bénéficier d’un chauffage écologique et de
              tarifs plus stables et compétitifs. France Chaleur Urbaine
              accompagne EVOS pour permettre au réseau de gagner en notoriété
              positive.
            </Text>
          </Box>
      ...
      <Box pt="10w" className="fr-container">
        <Box className="fr-grid-row fr-grid-row--gutters">
          ...
          >
            ...
            <Text size="lg">
              Pour atteindre 100% de logements collectifs raccordés et un taux
              d'énergies renouvelables de 80%, la ville de Fresnes a décidé de
              ...
              accompagné la ville et son délégataire Coriance dans une campagne
              de communication multi-supports&nbsp;: publicité pour le journal
              communal, affiches pour abribus et espaces d’affichage de la
              ville, ainsi qu’une petite vidéo pédagogique pour expliquer la
              géothermie aux plus jeunes.
            </Text>
          </Box>
          <Box className="fr-col fr-col-12 fr-col-lg-6">
            <Slideshow
      ...
      <Box pt="10w" className="fr-container">
        <Box className="fr-grid-row fr-grid-row--gutters">
          ...
          >
            ...
            <Text size="lg">
              De juillet 2023 à décembre 2024, le réseau de chaleur de
              Charleville-Mézières est étendu sur plus de 13 km. Cette période
              de travaux est un moment clé pour faire connaître le chauffage
              urbain et convaincre de nouveaux prospects de se raccorder. France
              Chaleur Urbaine a réalisé pour la ville et son délégataire Dalkia
              des visuels pour le journal communal, les bâches travaux, et de
              l’affichage sur abribus. Grâce à un relai actif par la
              collectivité, cette campagne a généré plus de 50 demandes de
      ...
      <Box py="10w" className="fr-container">
        <Box className="fr-grid-row fr-grid-row--gutters">
          ...
          >
            ...
            <Text size="lg">
              En mars 2023, France Chaleur Urbaine réalise sa première campagne
              d’affichage sur abribus, pour valoriser les réseaux de Bordeaux
              Métropole. 166 affiches sont installées sur Bordeaux rive droite,
              pendant une semaine.
            </Text>
          </Box>
          <Box className="fr-col fr-col-12 fr-col-lg-6">
            <Slideshow
              images={[
                '/img/campagnes_bordeaux_1.webp',
                '/img/campagnes_bordeaux_2.webp',
                '/img/campagnes_bordeaux_3.webp',
              ]}
            />
          </Box>
        </Box>
