...
const faqItems: FaqItem[] = [
        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                demande « non affectée » par France Chaleur Urbaine, car éloignée du réseau : la collectivité peut soit affecter la demande
                à son délégataire, si elle se situe sur le périmètre de la concession, soit apporter directement une réponse au demandeur.
              </li>
            </ul>
          </li>
          <li>
            L’<b>exploitant du réseau de chaleur</b> a accès aux demandes situées à proximité du réseau qu’il gère. Il apporte une réponse
            aux demandeurs et met à jour le statut de celles-ci.
          </li>
        </ul>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          L’information peut également être utile aux autorités délégantes qui se connectent sur leur espace : elles peuvent ainsi s’assurer
          que les demandes ont bien été vues par leur délégataire.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <b>Contact</b>, <b>Adresse</b>, <b>Type</b> (de bâtiment), <b>Mode de chauffage</b>
          </li>
        </ul>
        <p className="fr-mb-0">Informations complétées par France Chaleur Urbaine : </p>
        <ul>
          <li>
            Une étiquette “PDP” est ajoutée lorsque le bâtiment est situé dans un périmètre de développement prioritaire référencé sur
            France Chaleur Urbaine.{' '}
          </li>
          <li>
            <b>Distance au réseau (m) :</b> distance à vol d’oiseau entre le bâtiment et le réseau de chaleur le plus proche, calculée par
            France Chaleur Urbaine.
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Vous pouvez si vous le souhaiter modifier ou compléter les données sur la distance, le nombre de logements, consommations de gaz à
          l’adresse avec les informations dont vous disposez.
        </p>
        <p>
          Que vous soyez la collectivité ou l’exploitant d’un réseau, vous pouvez également utiliser la colonne « commentaire » pour toute
  ...
  return (
    <SimplePage title="Aide : France Chaleur Urbaine" mode="authenticated">
      <div className="fr-container fr-mt-4w fr-mb-8w">
        ...
        <p>
          Vous ne trouvez pas la réponse à vos interrogations, ou souhaitez nous faire part de suggestions pour améliorer cet espace
