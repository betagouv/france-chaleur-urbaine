const comparatifRcu = [
  ...
  },
  {
    ...
    props: {
      ...
      body: `Le [chauffage urbain](/chauffage-urbain#contenu) est le mode de chauffage **le moins cher sur le marché** pour les logements en habitat collectif (copropriété, logement social...) loin devant le gaz, l’électricité et le fioul dont les tarifs ne cessent d’augmenter.
