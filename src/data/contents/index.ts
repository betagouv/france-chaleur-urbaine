...
export const articles = (
  [
    ...
    },
    {
      ...
      slug: 'chiffres-cles-2023-des-reseaux-de-froid',
      content: importFile(chiffresCles2023rdf),
      publishedDate: new Date('2024-12-17'),
      themes: ['Infographie', 'Réseaux de froid', 'Cartographie et données'],
    },
    {
      image: '/contents/cover_classement.jpg',
      title: 'Classement des réseaux de chaleur',
      slug: 'classement-des-reseaux-de-chaleur',
      content: importFile(classementRdc),
      publishedDate: new Date('2024-12-11'),
      themes: ['Réseaux de chaleur', 'Réglementation'],
    },
    {
      image: '/contents/cover_chiffres_RCU.jpg',
      title: 'Chiffres-clés 2023 des réseaux de chaleur',
      slug: 'chiffres-cles-2023-des-reseaux-de-chaleur',
      content: importFile(chiffresCles2023rdc),
      publishedDate: new Date('2024-12-04'),
      themes: ['Infographie', 'Réseaux de chaleur', 'Cartographie et données'],
    },
    {
    ...
    },
    {
      ...
      title: 'Des obligations de partage de données à FCU au titre du Fonds Chaleur',
    ...
    },
    {
      ...
      title: "30% de l'objectif de raccordement 2035 atteignable sur les réseaux existants",
    ...
    },
    {
      ...
      title: "La carte France Chaleur Urbaine sur l'application Rezomee d'ENGIE Solutions",
    ...
    },
    {
      ...
      title: 'La cartographie la plus exhaustive des réseaux de chaleur et de froid',
    ...
    },
    {
      ...
      themes: ['Réseaux de chaleur', 'Réseaux de froid', 'Cartographie et données', 'Prix'],
    },
    {
  ...
  ] satisfies Omit<Article, 'abstract'>[]
).map((article) => ({ ...article, abstract: getArticleAbstract(article.content) }));
