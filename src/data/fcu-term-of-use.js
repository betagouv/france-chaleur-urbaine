...
- L'utilisation du service est subordonnée à l’acceptation préalable et au respect intégral des présentes conditions générales d’utilisation (CGU) par l’utilisateur.
...
- Afficher une carte centrée sur cette adresse montrant les réseaux de chaleur à proximité (hors Ile-de-France, renvoi actuel vers la carte ViaSeva)
- Saisir des informations vos coordonnées en vue d’obtenir des informations  techniques et commerciales de la part de l’opérateur du réseau de chaleur à proximité
...
- __*France Chaleur Urbaine*__

Les sources des informations diﬀusées sur la Plateforme sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.

Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement de la Plateforme et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de France Chaleur Urbaine.
...
Les données et informations personnelles ou relevant du secret des affaires ne relèvent pas du régime applicable à la Licence Ouverte V 2.0. Nous nous engageons à prendre toutes les mesures nécessaires pour garantir la sécurité et la confidentialité des données personnelles et des données relevant du secret des affaires que vous nous fournissez dans le cadre de l’utilisation du service.
