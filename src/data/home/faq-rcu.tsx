...
`,
  ...
  },
  {
    ...
    body: `Les aides financières suivantes sont disponibles pour le raccordement à un réseau de chaleur :

- Le [coup de pouce chauffage (Fiche CEE BAR-TH-137)](https://www.ecologie.gouv.fr/coup-pouce-chauffage-et-isolation) peut être mobilisé lors du remplacement du chauffage fossile d’un bâtiment résidentiel existant par un raccordement à un réseau de chaleur alimenté majoritairement par des énergies renouvelables et de récupération. Les travaux doivent être réalisés par une entreprise qualifiée RGE.
- [MaPrimeRenov'](https://www.maprimerenov.gouv.fr/), finance une grande variété de travaux d’isolation, de changement de mode de chauffage, ou encore de rénovation globale. Le raccordement à un réseau de chaleur est éligible, avec un montant par logement fonction des revenus des copropriétaires. Dans le cas où le raccordement s’inscrit dans des travaux de rénovation globale, avec un gain énergétique supérieur à 35 %, cette aide peut être complétée par MaPrimeRénov’Copropriétés, aide versée aux syndics des copropriétés pour les travaux effectués sur les parties communes. Enfin, toujours dans le cadre de travaux de rénovation globale, les ménages modestes et très modestes peuvent bénéficier de MaPrimeRénov’Sérénité, qui couvrira jusqu’à 50 % du coût des travaux, avec un plafond d’aide de 15 000 €.

Par ailleurs, pour les réseaux de chaleur alimentés à plus de 50 % par des énergies renouvelables et de récupération, un taux de TVA réduit à 5.5 % s’applique sur l’ensemble de la facture de chauffage.
`,
  },
  {
    label:
