...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`
    ...
    ALTER TABLE public.users ADD COLUMN IF NOT EXISTS "structure" varchar(255) NULL;
    ...
    ALTER TABLE public.users ADD COLUMN IF NOT EXISTS job varchar(255) NULL;
    ALTER TABLE public.users ADD COLUMN IF NOT EXISTS phone varchar(20);
    ALTER TABLE public.users ADD COLUMN IF NOT EXISTS besoins varchar(255)[];
    ...
    CREATE INDEX IF NOT EXISTS idx_users_structure ON public.users("structure");
...
export async function down(knex: Knex): Promise<void> {
  await knex.raw(`
    ...
    ALTER TABLE public.users DROP COLUMN IF EXISTS "structure";
    ...
    ALTER TABLE public.users DROP COLUMN IF EXISTS job;
    ALTER TABLE public.users DROP COLUMN IF EXISTS phone;
    ALTER TABLE public.users DROP COLUMN IF EXISTS besoins;
