...
import { Layout, Link, Table, TableColumn, TableRow, Text, TextFaded, Title } from '@/server/email/react-email/components';
...
const DemandAdminNewEmail = ({ demand }: { demand: AirtableLegacyRecord }) => {
  return (
    <Layout>
      ...
      <TextFaded>Cette demande a été automatiquement générée par le système France Chaleur Urbaine.</TextFaded>
    </Layout>
  );
};
