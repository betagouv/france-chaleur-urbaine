...
export const InscriptionEmail = (props: LayoutModifiableProps) => {
  const url = `${emailConfig.websiteUrl}/connexion`;
  ...
  Pour accéder à cet espace, il vous suffit de cliquer sur « [Espace gestionnaire](${url}) ». **Lors de la première connexion, il est nécessaire de cliquer sur "Mot de passe oublié" pour définir votre mot de passe.**
  ...
  **Nous invitons les gestionnaires des réseaux à renseigner le statut des demandes dès lors qu'elles sont prises en charge**. Cette information a uniquement pour but de nous permettre d'évaluer l'impact de notre service à l'échelle nationale.
  ...
  Pour rappel, [France Chaleur Urbaine](${emailConfig.websiteUrl}/collectivites-et-exploitants) est un **service du ministère de la transition énergétique qui vise à accélérer la dynamique de raccordement aux réseaux de chaleur**. France Chaleur Urbaine permet :
